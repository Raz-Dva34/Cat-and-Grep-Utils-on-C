...
## Есть тесты в том же Makefile

## Part 1. Разработка утилиты cat

cat:
- поддерживает все флаги (включая GNU версии)


## Part 2. Разработка утилиты grep
